...
import Fish_1_mlt from './assets/objects/fish_1/fish.mtl?url'
import Fish_1_obj from './assets/objects/fish_1/fish.obj?url'

import Fish_2_mlt from './assets/objects/fish_2/fish.mtl?url'
import Fish_2_obj from './assets/objects/fish_2/fish.obj?url'

import Fish_3_mlt from './assets/objects/fish_3/Shark.mtl?url'
import Fish_3_obj from './assets/objects/fish_3/Shark.obj?url'
...
class Simualtion {
    ...
    initSkyBox(): Texture {
        ...
        const texture = backgroundLoader.load(Background);
    ...
    #create_fish() {
        ...
        loader.load(Fish_1_mlt, (material) => {
            ...
            objLoader.load(Fish_1_obj, (object) => {
        ...
        loader.load(Fish_2_mlt, (material) => {
            material.preload();

            const objLoader = new OBJLoader();

            objLoader.setMaterials(material);
            objLoader.load(Fish_2_obj, (object) => {
    ...
    #create_sharks() {
        ...
        loader.load(Fish_3_mlt, (material) => {
            material.preload();

            const objLoader = new OBJLoader();

            objLoader.setMaterials(material);
            objLoader.load(Fish_3_obj, (object) => {
